...
//    deviceStrings.add("NNAPI");
          ...
          public void onStateChanged(@NonNull View bottomSheet, int newState) {
            switch (newState) {
              ...
              case BottomSheetBehavior.STATE_EXPANDED:
                {
                  bottomSheetArrowImageView.setImageResource(R.drawable.ic_baseline_expand_more_24);
                }
                break;
              case BottomSheetBehavior.STATE_COLLAPSED:
                {
                  bottomSheetArrowImageView.setImageResource(R.drawable.ic_baseline_expand_less_24);
                }
                break;
    ...
    ///
    RealResult = findViewById(R.id.realtimeresult);
    recyclerResult = findViewById(R.id.recycler_realtime);
...
//  }
  ...
  protected void showInference(String inferenceTime) {
    ...
    //RealResult.setText((CharSequence) SharedData.listcay);
    List<ThuocNam> thuocNam = database.getCayThuocByIdArray(SharedData.objects);
